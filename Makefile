...
ICONNAME=icons/nanos_app_ens.gif
else ifeq ($(TARGET_NAME), TARGET_STAX)
ICONNAME=icons/stax_app_ens.gif
DEFINES += ICONGLYPH=C_stax_ens_64px
DEFINES += ICONBITMAP=C_stax_ens_64px_bitmap
GLYPH_FILES += $(ICONNAME)
else
ICONNAME=icons/nanox_app_ens.gif
endif
