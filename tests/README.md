...
This directory contains non-regression tests for the ens plugin.
...
For example in the [plugin-ens CI](https://github.com/LedgerHQ/app-plugin-ens/actions/workflows/build_and_functional_tests.yml).


## Launching the tests

The plugin ens app comes with functional tests 
