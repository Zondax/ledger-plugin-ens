...
const PLUGIN_LIB_NANOS = { 'ENS': Resolve("elfs/plugin_nanos.elf") };
const PLUGIN_LIB_NANOX = { 'ENS': Resolve("elfs/plugin_nanox.elf") };
const PLUGIN_LIB_NANOSP = { 'ENS': Resolve("elfs/plugin_nanosp.elf") };
